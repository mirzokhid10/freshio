...
// Header inner toggle menu======//
// Mobile Search form==============
let bottomSearchButton = document.querySelector('.bottom-search-btn');
let mobileSearchForm = document.querySelector('.mobile__search-form');
let searchIcon = document.querySelector('.search-icon');

bottomSearchButton.addEventListener('click', function(){
    mobileSearchForm.classList.toggle('mobile__search-form--active');
...
bottomOptionsButton.addEventListener('click', function(){
    userOptions.classList.add('user-options--active');
    userOptionBg.classList.add('user-options__bg--active');
    siteBody.classList.add('body--disable');
});
